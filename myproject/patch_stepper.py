...
old_tracking = '''<!-- Tracking Progress Bar -->
                                    <div class="mb-4 bg-light p-3 rounded-3">
                                        <h6 class="mb-3 fw-bold">Tracking Status: <span class="text-primary">{{ order.status }}</span></h6>
...
new_tracking = '''<!-- Tracking Progress Bar -->
                                    <div class="mb-4 p-3">
                                        <style>
                                            .stepper-wrapper {
                                              margin-top: 10px;
